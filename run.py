...
def main(args):
  ...
  sp.call(f'cp {config.epoch1.origcsv}/{config.epoch1.prefix}* firstcsv/',
      shell=True,)
  sp.call(f'cp {config.epoch2.origcsv}/{config.epoch2.prefix}* secondcsv/',
      shell=True,)

  sp.call('python3 findgaia.py', shell=True,)
  sp.call('python3 qsomatch.py', shell=True,)
  ...
  sp.call('python3 qsocombine.py', shell=True,)
