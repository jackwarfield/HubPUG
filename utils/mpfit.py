        ...
        while 1:
            ...
            if (nprint > 0) and (iterfunct is not None):
                if ((self.niter - 1) % nprint) == 0:
                    ...
                    if self.status < 0:
                        self.errmsg = (
                            'WARNING: premature termination by '
                            + str(iterfunct)
                        )
                        return
            ...
            while 1:
                ...
                if (qanylim == 0) and (qminmax == 0):
                    ...
                    if qanylim:
                        ...
                        if nlpeg > 0:
                            wa1[whlpeg] = numpy.clip(
                                wa1[whlpeg], 0.0, numpy.max(wa1)
                            )
                        if nupeg > 0:
                            wa1[whupeg] = numpy.clip(
                                wa1[whupeg], numpy.min(wa1), 0.0
                            )
                    ...
                    if qminmax:
                        ...
                        whmax = (
                            numpy.nonzero(
                                (qmax[ifree] != 0.0) & (maxstep[ifree] > 0)
                            )
                        )[0]
                        if len(whmax) > 0:
                            mrat = numpy.max(
                ...
                for j in range(n):
                    wa3[j] = 0
                    wa3[0 : j + 1] = (
                        wa3[0 : j + 1] + fjac[0 : j + 1, j] * wa1[ipvt[j]]
                    )
